  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {{-- msg d'erreur --}}
        {{-- Formulaire Edition--}}
        <form id="etudiantForm" action="{{ route('commune.update_user') }}" method="POST" name="etudiantForm" class="form-horizontal">
            @csrf
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {{-- msg d'erreur --}}
        {{-- Formulaire Creation --}}
        <form id="etudiantFormCreate" action="{{ route('commune.create_user') }}" method="POST" name="etudiantFormCreate" class="form-horizontal_create">
            @csrf
            <div class="form-group">
                  <label for="user_pseudo"  class="control-label">Pseudo</label>
                  <div class="col-sm-12">
                      <input type="text"  class="form-control" id="user_pseudo" name="user_pseudo"  maxlength="50" required="">
                  </div>
              </div>
            <div class="form-group">
